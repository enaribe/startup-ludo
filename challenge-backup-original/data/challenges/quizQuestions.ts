export interface FinalQuizQuestion {
  id: string;
  block: number; // 1-4 (corresponds to level)
  blockName: string;
  question: string;
  options: string[];
...
export const YEAH_FINAL_QUIZ: FinalQuizQuestion[] = [
  // Block 1 - Découverte (4 questions about agricultural entrepreneurship basics)
  ...
  // Block 2 - Idéation (4 questions about pitch and value proposition)
  ...
  // Block 3 - Démarrage (4 questions about business plan and organization)
  ...
  // Block 4 - Réussite (4 questions about growth, innovation, impact, leadership)
